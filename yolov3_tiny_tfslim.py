...
from yolov3_big_tfslim import _conv2d_fixed_padding, _fixed_padding, _get_size, _detection_layer, _upsample
...
#_ANCHORS = [(4, 7), (7, 15), (13, 25), (25, 42), (41, 67), (75, 94), ]
        ...
        with slim.arg_scope([slim.conv2d, slim.batch_norm, _fixed_padding], reuse=reuse):
            with slim.arg_scope([slim.conv2d],
                ...
                with tf.variable_scope('yolo-v3-tiny'):
                    ...
                    detect_1, cl_1 = _detection_layer(inputs, num_classes, _ANCHORS[3:6], img_size, data_format)
                    detect_1 = tf.identity(detect_1, name='detect_1')
                    print "DETEC1", detect_1.get_shape()
                    ...
                    detect_2, cl_2 = _detection_layer(inputs, num_classes, _ANCHORS[0:3], img_size, data_format)
                    detect_2 = tf.identity(detect_2, name='detect_2')
                    print "DETEC2",detect_2.get_shape()
                    detections = tf.concat([detect_1, detect_2], axis=1)
                    detections = tf.identity(detections, name='detections')

                    cl_de = tf.concat([cl_1, cl_2], axis=1)
